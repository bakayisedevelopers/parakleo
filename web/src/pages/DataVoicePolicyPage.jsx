    ...
    <MainLayout>
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 text-zinc-800 dark:text-zinc-200">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7">
          <p>
            This policy gives extra detail about how Claxi handles live session data, microphone audio, screen sharing,
          ...
          <div>
            ...
            <p className="mt-3">
              Claxi sessions may request microphone access so students and tutors can speak during class. Audio is used to
              provide the live session. Claxi does not intentionally record, store, or transcribe live voice audio unless a
          ...
          <div>
            ...
            <p className="mt-3">
              To connect calls, Claxi may process WebRTC offers, answers, ICE candidates, connection state, relay usage,
          ...
          <div>
            ...
            <p className="mt-3">
              ...
              without permission. Claxi may process screen sharing state and related diagnostics to operate the feature.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3">
              Students may upload images or files related to a tutoring request. Claxi may use OCR or similar extraction tools
          ...
          <div>
            ...
            <p className="mt-3">
              Claxi may review account data, request details, session metadata, uploaded content, extracted text, messages,
