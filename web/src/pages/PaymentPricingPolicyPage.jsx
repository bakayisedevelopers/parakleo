    ...
    <MainLayout>
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 text-zinc-800 dark:text-zinc-200">
        ...
        <div className="mt-8 space-y-8 text-sm leading-7">
          <p>
            This policy explains how Claxi prices sessions, authorizes cards, manages wallet balances, handles outstanding debt,
          ...
          <div>
            ...
            <p className="mt-3">
              Claxi may calculate a session quote using lesson duration, base amount, rate per minute, subject, time of day,
          ...
          <div>
            ...
            <p className="mt-3">
              Students may be required to add a valid card before requesting a class. Claxi may authorize, charge, capture,
          ...
          <div>
            ...
            <p className="mt-3">
              ...
              as unpaid, processing, paid, or adjusted by administrators. Claxi may delay or withhold payouts for verification,
          ...
          <div>
            ...
            <p className="mt-3">
              Card entry and sensitive payment processing are handled by third-party payment providers. Claxi stores only the
          ...
          <div>
            ...
            <p className="mt-3">
              Claxi may update prices, fees, discounts, payout shares, supported payment methods, and billing rules from time to
