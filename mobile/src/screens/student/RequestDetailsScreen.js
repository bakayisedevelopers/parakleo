...
export function RequestDetailsScreen({ route, navigate, goBack }) {
  ...
  if (!request) {
    return <ErrorState title="Request not found" message="We could not find the class request you are looking for." />;
  }
  ...
  return (
    <View style={styles.wrap}>
      <Card style={styles.heroCard}>
        <Text style={styles.kicker}>Class request</Text>
        <Text style={styles.heroTitle}>{request.topic || 'Mathematics Request'}</Text>
      ...
      <Card style={styles.sectionCard}>
        ...
        <View style={styles.metricList}>
          ...
          <View style={styles.metric}>
            <Text style={styles.metricLabel}>Subject</Text>
            <Text style={styles.metricValue}>{request.subject || 'Mathematics'}</Text>
          </View>
          <View style={styles.metric}>
          ...
          <View style={styles.metric}>
            <Text style={styles.metricLabel}>Tutor</Text>
          ...
          <View style={styles.metric}>
            <Text style={styles.metricLabel}>Session details</Text>
            <Text style={styles.metricValue}>
              {relatedSession
