  ...
  return (
    <View style={styles.wrap}>
      <View style={styles.header}>
        ...
        <Text style={styles.description}>Manage payment cards and review your current Parakleo balance.</Text>
      </View>
      ...
      <Card style={styles.sectionCard}>
        ...
        <Text style={[styles.copy, hasOutstandingBalance ? styles.outstandingCopy : null]}>
          {hasOutstandingBalance
            ? `Outstanding amount owed to Parakleo: R${Math.abs(walletBalance).toFixed(2)}.`
